...
The client uses whichever KEM a gateway advertises, so it works with every KEM
[`ohttp`](https://crates.io/crates/ohttp) implements: DHKEM(X25519, HKDF-SHA256),
DHKEM(P-256, HKDF-SHA256), and X-Wing (ML-KEM-768 + X25519).
